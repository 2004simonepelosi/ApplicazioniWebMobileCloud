...
function Profilo() {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:3000/prenotazioni/utente/${u.id}`)
            .then(r => r.json())
        ...
        <div style={styles.schermo}>
            ...
            <div style={styles.stats}>
                <div style={styles.statCard}>
                    <p style={styles.statNumero}>{totalePrenotazioni}</p>
                    <p style={styles.statLabel}>Prenotazioni</p>
                </div>
                <div style={styles.statCard}>
                    <p style={styles.statNumero}>{prenotazioniAttive}</p>
                    <p style={styles.statLabel}>Attive</p>
                </div>
                <div style={styles.statCard}>
                    <p style={styles.statNumero}>{totalePrenotazioni - prenotazioniAttive}</p>
                    <p style={styles.statLabel}>Cancellate</p>
                </div>
            </div>
