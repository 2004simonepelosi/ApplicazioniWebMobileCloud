...
function Registrazione() {
    ...
    return (
        <div style={styles.schermo}>
            ...
            <form onSubmit={handleRegistrazione}>
                <div style={styles.rigaDoppia}>
                    ...
                    <div style={styles.colonna}>
                        ...
                        <input type="text" value={cognome} onChange={(e) => setCognome(e.target.value)} style={styles.input} />
                    </div>
                </div>
            ...
            {successo && <p style={styles.successo}>Registrazione completata! Reindirizzo al login...</p>}

            <p style={styles.testoLink}>
                Hai già un account? <Link to="/login" style={styles.link}>Accedi</Link>
            </p>
        </div>
    );
}
...
const styles = {
    ...
    sottotitolo: { color: '#888780', fontSize: '14px', margin: '0 0 28px' },
    ...
    successo: { color: '#97C459', fontSize: '13px', marginTop: '12px' },
